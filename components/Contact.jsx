        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full rounded-xl">
              ...
              <div>
                <h2 className="py-4">Asad Lukman</h2>
                <p>Web Developer || UI Designer</p>
                <p className="py-4">
                  I'm available for freelance and full-time positions. Let's connect and talk!
                </p>
              </div>
              ...
              <div className="pt-20">
                ...
                <div className="justify-between flex items-center py-4">
                  ...
                  <a
                    href="https://drive.google.com/file/d/1aMy_7x1A5P8Xsu115cdqzE7VsWq9ttOA/view?usp=share_link"
                    className="rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
          ...
          <div className="shadow-xl shadow-gray-400 h-auto w-full rounded-xl lg:p-4 col-span-3">
            <div className="py-4">
              <form>
                ...
                <button className="uppercase w-full p-4 mt-4 text-gray-100 bg-[#5651e5] cursor-pointer">
                  send message
                </button>
              </form>
            </div>
