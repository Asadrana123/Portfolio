  ...
  return (
    <div id='about' className='w-full md:h-screen p-2 flex py-16 items-center'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        ...
        <p className='py-2 text-gray-600'>I am a Front End Engineer with over a year of professional
        ...
        <p className='py-2 text-gray-600'>Currently working as a Front End Engineer at Rangi Lalls, I have contributed to projects that serve high-traffic environments and have experience mentoring others through my role as a Teaching Assistant at Coding Ninjas. I am passionate about writing clean, efficient code and continuously learning new technologies to stay at the forefront of software development.</p>
